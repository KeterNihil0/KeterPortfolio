...
public class matoran extends EntityModel {
	...
	public matoran() {
		...
		head.cubeList.add(new ModelBox(head, 0, 48, -4.0F, -8.0F, -4.0F, 8, 8, 8, 0.5F, false));

		body = new RendererModel(this);
		body.setRotationPoint(0.0F, 10.0F, 0.0F);
		body.cubeList.add(new ModelBox(body, 32, 0, -4.0F, 4.0F, -2.0F, 8, 6, 4, 0.0F, false));

		left_arm_container = new RendererModel(this);
		left_arm_container.setRotationPoint(6.0F, 15.0F, 0.0F);
		setRotationAngle(left_arm_container, -0.4363F, 0.2618F, -1.0472F);
		

		left_arm = new RendererModel(this);
		left_arm.setRotationPoint(0.0F, 0.0F, 0.0F);
		left_arm_container.addChild(left_arm);
		left_arm.cubeList.add(new ModelBox(left_arm, 16, 16, -2.0F, -1.0F, -2.0F, 4, 12, 4, 0.0F, false));

		right_arm_container = new RendererModel(this);
		right_arm_container.setRotationPoint(-6.0F, 15.0F, 0.0F);
		setRotationAngle(right_arm_container, -0.4363F, -0.2618F, 1.0472F);
		

		right_arm = new RendererModel(this);
		right_arm.setRotationPoint(0.0F, 0.0F, 0.0F);
		right_arm_container.addChild(right_arm);
		right_arm.cubeList.add(new ModelBox(right_arm, 0, 16, -2.0F, -1.0F, -2.0F, 4, 12, 4, 0.0F, false));

		left_leg = new RendererModel(this);
		left_leg.setRotationPoint(2.0F, 20.0F, 0.0F);
		setRotationAngle(left_leg, 0.0F, -0.1745F, 0.0F);
		left_leg.cubeList.add(new ModelBox(left_leg, 20, 32, -1.0F, 0.0F, -4.0F, 4, 4, 6, 0.0F, false));

		right_leg = new RendererModel(this);
		right_leg.setRotationPoint(-2.0F, 20.0F, 0.0F);
		setRotationAngle(right_leg, 0.0F, 0.1745F, 0.0F);
		right_leg.cubeList.add(new ModelBox(right_leg, 0, 32, -3.0F, 0.0F, -4.0F, 4, 4, 6, 0.0F, false));
	}
