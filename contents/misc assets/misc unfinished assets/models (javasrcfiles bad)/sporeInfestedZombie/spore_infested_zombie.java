...
public class spore_infested_zombie extends EntityModel {
	...
	public spore_infested_zombie() {
		...
		mushroom_2.setRotationPoint(-2.6666F, -0.5831F, 1.2436F);
		...
		rightArm.cubeList.add(new ModelBox(rightArm, 88, 0, -3.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, false));

		leftArm = new RendererModel(this);
		leftArm.setRotationPoint(5.0F, 2.0F, 0.0F);
		setRotationAngle(leftArm, -1.5708F, 0.0F, 0.0F);
		leftArm.cubeList.add(new ModelBox(leftArm, 104, 0, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, true));
